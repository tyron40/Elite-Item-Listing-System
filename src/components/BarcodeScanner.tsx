          ...
          {mode === "camera" ? (
            <>
              ...
              <div className="relative overflow-hidden rounded-xl bg-black ring-1 ring-white/10">
                <video ref={videoRef} autoPlay playsInline muted className="w-full object-cover" style={{ aspectRatio: "4/3" }} />
              ...
              <div className="mt-3 rounded-lg bg-gray-800/80 px-3 py-2 text-center">
                <p className="text-sm font-medium text-gray-200">{scanning ? "Point the camera at a barcode" : "Barcode detected"}</p>
                {scanning && <p className="mt-1 text-xs text-gray-500">Keep the code inside the green scan line</p>}
              </div>
            </>
          ) : (
