            ...
            <>
              ...
              <div className="relative overflow-hidden rounded-xl bg-black ring-1 ring-white/10">
                ...
                <div className="pointer-events-none absolute inset-0 flex items-center justify-center p-8">
                  <div className="flex h-full w-full flex-col items-center justify-center rounded-lg border-2 border-emerald-400/70 bg-black/10">
                    <div className="rounded-full bg-black/50 px-3 py-1.5 text-xs font-medium text-white backdrop-blur-sm">Center the product here</div>
                  </div>
                </div>
              </div>
              <p className="mt-2 text-center text-xs text-gray-400">Use good lighting and keep the product inside the frame</p>
            </>
          )}
