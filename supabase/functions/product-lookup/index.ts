...
4. HIGHEST/RETAIL PRICE: Pricing is required whenever a real product is identified. Search broadly across the manufacturer's official store, major retailers, and marketplaces including Amazon, eBay, Best Buy, Walmart, B&H, Newegg, Target, and other sellers. Find the highest legitimate current retail or listed sale price for the exact product or closest confirmed variant. Prefer a new/sealed retail price over used, open-box, parts-only, auction bid, or accessory prices. Return the single highest reliable price you can find in USD. Do not use an MSRP or price you cannot verify from a source page. Only return 0 when no legitimate price can be found anywhere after searching.

5. HIGHEST PRICE SOURCE URL: Include "highestPriceSourceUrl" as the direct, clickable product/listing URL where that highest price is shown. This field is required whenever highestPrice is greater than 0. Never leave it empty if any reliable price was found. The URL must be a real product page, not a search results page.
